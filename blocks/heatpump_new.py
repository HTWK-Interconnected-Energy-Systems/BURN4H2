...
class Heatpump:
    ...
    def heatpump_block_rule(self, block):
        ...
        block.capacity_compressor = Var(t, domain=NonNegativeReals) # Leistung Verdichter [kW]
        ...
        block.electrical_efficiency = Param(t, initialize=0.8) # Elektrische Effizienz Verdichter
        ...
        block.max_capacity_compressor = Param(t, initialize=313) # Maximaler Verdichterleistung [kW]
        block.electrical_efficiency_compressor = Param(t, initialize=0.8) # Elektrische Effizienz Verdichter
        ...
        # block.a = Param(t, mutable=True, initialize=1)

        # def a_rule(_block, i):
        #     return _block.a[i] == 2 + 30
        
        # block.a_constraint = Constraint(
        #     t,
        #     rule=a_rule
        # )
        ...
        def power_rule(_block, i):
            ...
            return _block.power[i] * 1000  == _block.capacity_compressor[i] / _block.electrical_efficiency[i]
        ...
        # easy_way = False # True if you want to use a constant power input
        
        # def balance_rule(_block, i):
        #     """Rule for the energy balance."""
        #     return _block.heat[i] == _block.capacity_compressor[i] + _block.heat_input[i]
        ...
        # block.max_heatpump_capacity_constraint = Constraint(
        #     t,
        #     rule=max_heatpump_capacity_rule
        # )


        # block.min_heatpump_capacity_constraint = Constraint(
        #     t,
        #     rule=min_heatpump_capacity_rule
        # )
        ...
        # block.balance_constraint = Constraint(
        #     t,
        #     rule=balance_rule
        # )
        ...
        # block.massflow_refigerant_constraint = Constraint(
        #     t,
        #     rule=massflow_refigerante_rule
        # )
